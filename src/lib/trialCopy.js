/** Textos de marketing do trial — fonte única alinhada a lib/billing/trialConstants.js */
export { TRIAL_DAYS } from '../../lib/billing/trialConstants.js';

import { TRIAL_DAYS } from '../../lib/billing/trialConstants.js';

export const trialMarketing = {
  ...
  metaDescription: `Teste grátis por ${TRIAL_DAYS} dias, sem cartão.`,
};
