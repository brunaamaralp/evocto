/**
 * Netlify Function — sugestão de temas do plano anual.
 * Exposed as /api/campanha-anual-temas via netlify.toml / _redirects.
 */
...
export async function handler(event) {
  try {
    ...
    const res = buildRes();
    await gerarTemasAnualHandler(req, res);
    if (!res.finished) {
      return {
        statusCode: 500,
    ...
    console.error('[netlify campanha-anual-temas]', err);
    return {
      statusCode: 500,
      headers: { 'Content-Type': 'application/json' },
