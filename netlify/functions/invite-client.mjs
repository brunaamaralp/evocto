/**
 * Netlify Function — invite client to portal.
 * Exposed as /api/invite-client via netlify.toml redirect.
 */
...
export async function handler(event) {
  try {
    ...
    const res = buildRes();
    await inviteClientHandler(req, res);
    if (!res.finished) {
      return {
        statusCode: 500,
    ...
    console.error('[netlify invite-client]', err);
    return {
      statusCode: 500,
      headers: { 'Content-Type': 'application/json' },
