      ...
      switch (route) {
        ...
        default:
          return json(res, 400, {
            error: 'unknown_route',
            message:
              'Informe ?route=bootstrap|overview|annual-plan|campaigns|campaign|client-actions|complete-client-action|decide-content|shared-tasks|documents|services|pending-actions|approvals|approval-detail|decide',
          });
      }
    }
